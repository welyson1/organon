...
import br.com.organon.classes.Desenvolvedor;
import br.com.organon.classes.Empregado;
        ...
        try{
            ...
            if(rst.next()){
               ...
               if(rst.getInt("tipo") == 0 ){
                   ...
                   dev.setNum_TarToDo(tar.buscarTodas(dev.getId(),1).size());
                   dev.setNumTarDone(tar.buscarTodas(dev.getId(),3).size());
